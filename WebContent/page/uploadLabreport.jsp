			...
			<div class="layui-form-item">
			    <div class="layui-inline">
			      ...
			      <div class="layui-input-inline grade" style="width: 400px">
			      	...
			      	<input type="hidden" style="width: 297px;display: inline-block;" name="labreportId" readonly="readonly" id="fileUrl" autocomplete="off" class="layui-input">
...
layui.use(['table','form', 'laydate'], function(){
	...
	form.on('submit(updateLabreport)', function(data){
		...
		$.ajax({
			url:'<%=basePath%>student/updateLabreport',
			type:'post',
			dataType:'json',
