			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="#" type="admin" class="active" id="courseManager"><i class="fa fa-tasks"></i> <span>课程管理</span></a></li>
		...
		<div class="main">
			...
			<div class="main-content">
				<div class="container-fluid">
					<div>
						<button type="button" class="layui-btn" lay-submit lay-filter="addCourse" id="addCourse">新增</button>
					</div>
					<div>
	...
	<script type="text/javascript">
		...
		$("#addCourse").click(function(){
			layer.open({
				...
				title : '新增',
				btnAlign: 'c',
			  	content: '<%=basePath%>page/edit_course.jsp',
			  	btn : ['确定','取消'],
			  	area : ['400px','180px'],
			  	yes : function(index, layero){
			  		var body = layer.getChildFrame('body',index);//建立父子联系
		            var iframeWin = window[layero.find('iframe')[0]['name']];
		           	iframeWin.updateCourse();
			  	}
			});
		});
		...
		function loadTable(){
			layui.use(['laydate','form','table'], function(){
				...
				table.render({
					elem: '#courses'
				    ,height: 490
				    ,url: '<%=basePath%>admin/getCourseList' //数据接口
				    ,page: true //开启分页
				    ,cols: [[ //表头
