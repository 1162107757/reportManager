...
<body>
			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="#" type="admin" class="active" id="studentManager"><i class="fa fa-users"></i> <span>学生管理</span></a></li>
		...
		<div class="main">
			...
			<div class="main-content">
				<div class="container-fluid">
					<div>
						<button type="button" class="layui-btn" lay-submit lay-filter="addStudent" id="addStudent">新增</button>
					</div>
					<div>
	...
	$("#addStudent").click(function(){
		layer.open({
			...
			title : '新增',
			btnAlign: 'c',
		  	content: '<%=basePath%>page/edit_student.jsp',
		  	btn : ['确定','取消'],
		  	area : ['400px','350px'],
		  	yes : function(index, layero){
		  		var body = layer.getChildFrame('body',index);//建立父子联系
	            var iframeWin = window[layero.find('iframe')[0]['name']];
	           	iframeWin.updateStudent();
		  	}
		});
	});
				...
				layer.open({
					...
					btnAlign: 'c',
				  	...
				  	success:function(layero, index){
				  		var body = layer.getChildFrame('body',index);//建立父子联系
			            var iframeWin = window[layero.find('iframe')[0]['name']];
			           	iframeWin.loadStudent(obj.data);
				  	}
				});
			}
		})
	...
	function loadTable(){
		layui.use(['laydate','form','table'], function(){
			...
			table.render({
				elem: '#students'
			    ,height: 490
			    ,url: '<%=basePath%>admin/getStudentList' //数据接口
			    ,page: true //开启分页
			    ,cols: [[ //表头
