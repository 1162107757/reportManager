...
<body>
	...
	<div id="wrapper">
		...
		<div id="sidebar-nav" class="sidebar">
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						<li><a href="#" type="student" class="active" id="labreport"><i class="fa fa-file-text-o"></i> <span>实验报告</span></a></li>
						<li><a href="#" type="student" class="" id="assignment"><i class="fa fa-file-text-o"></i> <span>作业列表</span></a></li>
						<li><a href="#" type="student" class="" id="finalScore"><i class="fa fa-file-text-o"></i> <span>查看成绩</span></a></li>
					</ul>
				</nav>
			</div>
		</div>
	...
	<script type="text/html" id="opertion">
		<button style="width: 70px;" id="deleteProduct" class="layui-btn layui-btn-xs" lay-event="downloadLabrepost"><i class="icons icon_revise"></i>下载作业</button>
		<button style="width: 70px;" id="deleteProduct" class="layui-btn layui-btn-xs" lay-event="uploadLabreport"><i class="icons icon_revise"></i>提交作业</button>
	</script>
	<script type="text/javascript">
		layui.use('table', function(){
			var table = layui.table;
			table.on('tool(labreposts)', function(obj){
				if(obj.event === 'downloadLabrepost'){
					window.location.href = obj.data.fileUrl;
				}else if(obj.event === 'uploadLabreport'){
					layer.open({
						type : 2,				
						title : '提交作业',
						btnAlign: 'c',
					  	content: '<%=basePath%>page/uploadLabreport.jsp',
					  	btn : ['确定','取消'],
					  	area : ['600px','230px'],
		...
		function loadTable(){
			layui.use(['laydate','form','table'], function(){
				...
				table.render({
					elem: '#labreposts'
				    ,height: 490
				    ,url: '<%=basePath%>student/getLabreportList' //数据接口
				    ,page: true //开启分页
				    ,cols: [[ //表头
