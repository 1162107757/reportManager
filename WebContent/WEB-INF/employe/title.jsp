		...
		<ul class="nav navbar-nav navbar-right">
			<li class="dropdown">
				...
				<ul class="dropdown-menu">
					<li id="updatePassword" type="employe"><a href="#"><i class="fa fa-edit"></i> <span>修改密码</span></a></li>
					<li id="loginout" type="employe"><a href="#"><i class="lnr lnr-exit"></i> <span>退出</span></a></li>
				</ul>
			</li>
		</ul>
	</div>
